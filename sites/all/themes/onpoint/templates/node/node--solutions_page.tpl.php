<article<?php print $attributes; ?>>
  ...
  <?php if (isset($content['field_highlight_bar'])) { ?>
  ...
  <?php } if (isset($content['field_body_bottom_'])) { ?>
  ...
  <?php } if (isset($content['field_hubspot_cta']) || isset($content['field_cta_link']) || isset($content['field_informational_pdf'])) {?>
	  <div id="cta-wrapper">
	    <div class="l-main cta-inner asas">
		  <div>
